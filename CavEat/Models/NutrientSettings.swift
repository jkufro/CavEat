...
class NutrientSettings: ObservableObject {
    ...
    private static var defaultSettings: [String: NutrientSetting] = [
        ...
        "Trans Fat": NutrientSetting(id: UUID(uuidString: "55DADEE5-95BD-4105-82F3-1F0B20C67DA6")!, name: "Trans Fat", unit: "g", dailyValue: 2, minValue: 0, maxValue: 10, valueStep: 0.5, defaultValue: 2, sortingOrder: 30),
        ...
        "Total Carbohydrates": NutrientSetting(id: UUID(uuidString: "2A0825B4-BC1F-40F7-AECB-EDCAB7367B69")!, name: "Total Carbohydrates", unit: "g", dailyValue: 300, minValue: 0, maxValue: 500, valueStep: 20, defaultValue: 300, sortingOrder: 60),
        ...
        "Protein": NutrientSetting(id: UUID(uuidString: "1DC27A39-E7B1-41FC-B05F-71DF89FA8EB5")!, name: "Protein", unit: "g", dailyValue: 50, minValue: 0, maxValue: 120, valueStep: 1, defaultValue: 50, sortingOrder: 100)
    ]
